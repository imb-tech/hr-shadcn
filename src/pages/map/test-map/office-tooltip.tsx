          ...
          <Card className="relative !z-50">
            <CardContent className="p-4">
              <div className="flex flex-row items-end gap-1">
                <Building size={22} />
                <span className="block text-[16px] m-0">{properties.name}</span>
              </div>
              <div className="flex gap-3 p-2 justify-between items-center">
                ...
                {/* <CircularProgress
                  ...
                  className={`${hover ? "" : "opacity-0 hidden"}`}
                  value={properties.persentage}
                /> */}
              </div>
            </CardContent>
          </Card>
